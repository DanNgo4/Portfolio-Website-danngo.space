...
const TTTAndroidJava = () => {
    return (
        <section>
            ...
            <ProjectFigure src={Figure1} alt="Tic Tac Toe game interface on Android" title="Figure 1: Starting screen (Main Activity)" />
            ...
            <ProjectFigure src={Figure2} alt="Tic Tac Toe game interface design in Android Studio" title="Figure 2: The game's interface design in activity_game.xml" />
            ...
            <ProjectFigure src={Figure3} alt="Tic Tac Toe game running on Android Studio's emulator" title="Figure 3" />
